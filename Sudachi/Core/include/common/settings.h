...
namespace YuzuSettings {

const char* TranslateCategory(YuzuSettings::Category category);
...
class PlayerInputSetting final {
public:
    PlayerInputSetting() = default;
    explicit PlayerInputSetting(Type val) : Setting<Type>(val) {}
    ~PlayerInputSetting() = default;
...
struct YuzuValues {
    ...
    // Controls
    PlayerInputSetting<std::array<PlayerInput, 10>> players;
